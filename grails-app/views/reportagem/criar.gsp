		...
		<section id="content" class="col-lg-12">
			...
			<article>
				<div class="centralizar">
                    <span class="titulo_artigo">Criar Reportagens</span>
				</div>				
				<br>
				<form id="formulario" class="form-horizontal" method="post" action="/educafro/reportagem/cadastrar" enctype="multipart/form-data" >
