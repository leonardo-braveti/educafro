	<div class="centralizar">
        ...
        <br>
		<form id="formulario" class="form-horizontal" method="post" action="/educafro/livro/atualizar" enctype="multipart/form-data" >
					<div class="form-group">
          				<label class="col-lg-3 control-label format">Identificador</label>
						<div class=" col-lg-7">
							<input type="text" class="form-control" id="id" name="id" ng-model="livro.id" readonly>
						</div>
					</div> 				
					...
					<div class="form-group">
						...
						<div class=" col-lg-7">
							<input type="text" class="form-control" id="titulo" name="titulo" ng-model="livro.titulo">
						</div>
					</div> 				
					...
					<div class="form-group">
						...
						<div class=" col-lg-7">
							<input type="text" class="form-control" id="descricao" name="descricao" ng-model="livro.descricao">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-lg-7">
							<input type="text" class="form-control" id="inclusao" name="inclusao" ng-model="livro.dataInclusao" readonly>
						</div>
					</div>
