...
<head>
    ...
    <script src="/educafro/js/pesquisas.js" ></script>
</head>
<body>
	<div id="container" class="width">
        ...
        <div id="body" class="width" ng-controller="pesquisaController">
		<section id="content" class="col-lg-12">
			...
			<article>
				<div class="centralizar">
					<span class="titulo_artigo">Listar Pesquisas</span>
				</div>
				<br>
					...
					<tbody>					
						<tr ng-repeat= "l in pesquisas" >
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp
                                                        <a href="/educafro/pesquisa/excluir/{{l.id}}">
