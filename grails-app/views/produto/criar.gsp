		...
		<section id="content" class="col-lg-12">
			...
			<article>
				<div class="centralizar">
					<span class="titulo_artigo">Criar produto</span>
				</div>				
				<br>
				<form id="formulario" class="form-horizontal" method="post" action="/educafro/produto/cadastrar" enctype="multipart/form-data" >
