...
<head>
    ...
    <script src="/educafro/js/filmes.js" ></script>
</head>
<body>
		...
		<section id="content" class="col-lg-12">
			...
			<article>
				<div class="centralizar">
                    <span class="titulo_artigo">Criar Filmes</span>
				</div>				
				<br>
				<form id="formulario" class="form-horizontal" method="post" action="/educafro/filme/cadastrar" enctype="multipart/form-data" >
					...
					<div class="form-group">
						...
						<div class=" col-lg-7">
							<input type="text" class="form-control" id="link" name="link" ng-model="filme.link">
						</div>
					</div>
