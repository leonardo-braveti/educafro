...
<body>
	<div id="container" class="width">
        ...
        <div id="body" class="width" ng-controller="filmeController">
		<section id="content" class="col-lg-12">
			...
			<article>
				<div class="centralizar">
					<span class="titulo_artigo">Listar Filmes</span>
				</div>
				<br>
					...
					<tbody>					
						<tr ng-repeat= "l in filmes" >
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp
                                                        <a href="/educafro/filme/excluir/{{l.id}}">
